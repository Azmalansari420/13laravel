              ...
              <div class="tour-package-box style-3 bg-white-color">
               ...
               {{--    <div class="location">
                  ...
                  <h5 class="title line-clamp-2">
                    <a onclick="showModal('{{ $data->name }}', '{{ $data->price }}', '{{ $data->duration }}')" href="javascript:void(0)">{{$data->name}}</a>
                  </h5>
                  ...
                  <div class="text-center">
                    <button style="background: #fe0000;" type="button" class="mybutton btn btn-primary mt-3" onclick="showModal('{{ $data->name }}', '{{ $data->price }}', '{{ $data->duration }}')"/>Enquiry Now</button> 
                  </div>
                </div>
              </div>
            </div>
