   ...
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
        ...
        <li class="{{ $currentUrl == route('admin.site_setting.edit', ['id' => 1]) ? 'active' : '' }}">
         ...
         <li class="{{ $currentUrl == route('admin/packagedirectenquiry/list') ? 'active' : '' }}">
            <a href="{{ route('admin/packagedirectenquiry/list') }}">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
         ...
         <li class="has-sub">
            ...
            <ul class="nav-submenu">
               ...
               <li class=""><a href="{{ route('admin.content.edit', ['id' => 4]) }}"><span class="nav-text">About Us(Home)</span></a></li>
            </ul>
         </li>
