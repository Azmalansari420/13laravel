...
class Destination extends Controller
{
    protected $arr_values = array(
                            ...
                            'upload_path'=>'media/uploads/destination/',
                            'table_data_page_url'=>'admin/destination/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/destination/list',
                            /*add page*/
                            'add_page_view'=>'admin/destination/add',
                            'add_page_link'=>'destination/add',
                            'add_in_database_url'=>'admin_con/destination/add_data',
                            /*edit page*/
                            'edit_page_url'=>'admin/destination/edit',
                            'update_in_database_url'=>'admin_con/destination/update_data',
                            'status_url'=>'admin/destination/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/destination/delete_data',
                            'multiple_delete'=>'admin_con/destination/multiple_delete_data',
                            'check_image'=>true,    
