...
class Packageenquiry extends Controller
{
    protected $arr_values = array(
                            ...
                            'table_name'=>'packageenquiry',
                            'upload_path'=>'media/uploads/packageenquiry/',
                            'table_data_page_url'=>'admin/packageenquiry/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/packageenquiry/list',
                            /*add page*/
                            'view_page_url'=>'admin/packageenquiry/view',
                            /*delete*/
                            'delete_single_url'=>'admin_con/packageenquiry/delete_data',
                            'multiple_delete'=>'admin_con/packageenquiry/multiple_delete_data',
                            'check_image'=>false,  
                           ); 
