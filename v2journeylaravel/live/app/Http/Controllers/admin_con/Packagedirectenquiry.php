...
class Packagedirectenquiry extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Package Enquiry',
                            'table_name'=>'packagedirectenquiry',
                            'upload_path'=>'media/uploads/packagedirectenquiry/',
                            'table_data_page_url'=>'admin/packagedirectenquiry/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/packagedirectenquiry/list',
                            /*add page*/
                            'view_page_url'=>'admin/packagedirectenquiry/view',
                            /*delete*/
                            'delete_single_url'=>'admin_con/packagedirectenquiry/delete_data',
                            'multiple_delete'=>'admin_con/packagedirectenquiry/multiple_delete_data',
                            'check_image'=>false,  
                           ); 
    ...
    // Display all packagedirectenquiry
    ...
    public function getTableData(Request $request)
    {
        ...
        if (!empty($search)) {
            $query->where('name', 'LIKE', "%{$search}%")
                  ...
                  ->orWhere('selected_name', 'LIKE', "%{$search}%")
