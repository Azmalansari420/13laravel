...
use App\Http\Controllers\admin_con\Packagedirectenquiry;
...
/*------------------------contact----------------------*/
Route::prefix('admin/packagedirectenquiry')->group(function () {
    Route::get('/', [Packagedirectenquiry::class, 'listing'])->name('admin/packagedirectenquiry/list');
    Route::post('/table', [Packagedirectenquiry::class, 'getTableData'])->name('admin/packagedirectenquiry/table');
    /*------View------*/
    Route::get('/view/{id}', [Packagedirectenquiry::class, 'view_page_url'])->name('admin/packagedirectenquiry/view');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Packagedirectenquiry::class, 'delete_data'])->name('admin_con/packagedirectenquiry/delete_data');
    Route::delete('/multiple_delete_data', [Packagedirectenquiry::class, 'multiple_delete_data'])->name('admin_con/packagedirectenquiry/multiple_delete_data');
});
