  ...
  =================-->
    <!-- <div class="preloader">
      ...
      <div class="preloader-inner">
        <img src="{{url('public/media/uploads/site_setting/'.$sitesetting->logo)}}" alt="logo" />
    ...
    <div class="vs-menu-wrapper">
      <div class="vs-menu-area text-center">
        <div class="mobile-logo">
          <a href="{{url('')}}"
            ><img src="{{url('public/media/uploads/site_setting/'.$sitesetting->logo)}}" alt="<?=env('website_name') ?>" class="logo header-logomobile-img"
          /></a>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-auto col-lg-2">
            ...
            <div class="logo d-none d-lg-block">
              <a href="{{url('')}}"
                ><img src="{{url('public/media/uploads/site_setting/'.$sitesetting->logo)}}" alt="<?=env('website_name') ?>" class="logo"
              /></a>
            </div>
          </div>
