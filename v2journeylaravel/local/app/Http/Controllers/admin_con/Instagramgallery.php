...
class Instagramgallery extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Instagram Gallery',
                            'table_name'=>'instagramgallery',
                            'upload_path'=>'media/uploads/instagramgallery/',
                            'table_data_page_url'=>'admin/instagramgallery/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/instagramgallery/list',
                            /*add page*/
                            'add_page_view'=>'admin/instagramgallery/add',
                            'add_page_link'=>'instagramgallery/add',
                            'add_in_database_url'=>'admin_con/instagramgallery/add_data',
                            /*edit page*/
                            'edit_page_url'=>'admin/instagramgallery/edit',
                            'update_in_database_url'=>'admin_con/instagramgallery/update_data',
                            'status_url'=>'admin/instagramgallery/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/instagramgallery/delete_data',
                            'multiple_delete'=>'admin_con/instagramgallery/multiple_delete_data',
                            'check_image'=>true,    
