...
class Clients extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Clients',
                            'table_name'=>'clients',
                            'upload_path'=>'media/uploads/clients/',
                            'table_data_page_url'=>'admin/clients/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/clients/list',
                            /*add page*/
                            'add_page_view'=>'admin/clients/add',
                            'add_page_link'=>'clients/add',
                            'add_in_database_url'=>'admin_con/clients/add_data',
                            /*edit page*/
                            'edit_page_url'=>'admin/clients/edit',
                            'update_in_database_url'=>'admin_con/clients/update_data',
                            'status_url'=>'admin/clients/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/clients/delete_data',
                            'multiple_delete'=>'admin_con/clients/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'clients',
                            'page_name'=>'clients-details',    
