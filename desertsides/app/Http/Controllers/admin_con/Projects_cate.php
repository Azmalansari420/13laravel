...
class Projects_cate extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Project Category',
                            'table_name'=>'projects_cate',
                            'upload_path'=>'media/uploads/projects_cate/',
                            'table_data_page_url'=>'admin/projects_cate/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/projects_cate/list',
                            /*add page*/
                            'add_page_view'=>'admin/projects_cate/add',
                            'add_page_link'=>'projects_cate/add',
                            'add_in_database_url'=>'admin_con/projects_cate/add_data',
                            /*edit page*/
                            'edit_page_url'=>'admin/projects_cate/edit',
                            'update_in_database_url'=>'admin_con/projects_cate/update_data',
                            'status_url'=>'admin/projects_cate/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/projects_cate/delete_data',
                            'multiple_delete'=>'admin_con/projects_cate/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'projects_cate',
                            'page_name'=>'projects',    
