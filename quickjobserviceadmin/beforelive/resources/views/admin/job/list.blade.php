   ...
   <body>
                        ...
                        <form class="row justify-content-center">
                            ...
                            <div class="col-3 form-group ">
                                ...
                                <select class="selectpicker form-control" required name="cat_id" data-style="btn-default" data-live-search="true" id="cat_id">
                                  ...
                                  <?php
                                  $city = DB::table('category')->where('status',1)->get();
                                  foreach($city as $data)
                                     { ?>
    ...
    <script>
       ...
       $(document).ready(function() {
        ...
        $(document).on("change", "#country_id,#state_id,#cat_id",(function(e) {
          filterdata();
        }));
        ...
        function filterdata(offset = 0) 
        {
            ...
            if(cat_id === "--Select Category --" || cat_id === null) {
                cat_id = ""; 
            }
            if(country_id === "--Select Country --" || country_id === null) {
                country_id = ""; 
            }

                console.log("Sending ->", country_id, state_id, cat_id);
