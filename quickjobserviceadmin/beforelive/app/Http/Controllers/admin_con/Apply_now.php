...
class Apply_now extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Apply Enquiry',
                            'table_name'=>'apply_now',
                            'upload_path'=>'media/uploads/apply_now/',
                            'table_data_page_url'=>'admin/apply_now/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/apply_now/list',
                            /*add page*/
                            'view_page_url'=>'admin/apply_now/view',
                            /*delete*/
                            'delete_single_url'=>'admin_con/apply_now/delete_data',
                            'multiple_delete'=>'admin_con/apply_now/multiple_delete_data',
                            'check_image'=>false,  
                           ); 
