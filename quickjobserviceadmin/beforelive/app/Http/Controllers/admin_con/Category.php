...
class Category extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Category',
                            'table_name'=>'category',
                            'upload_path'=>'media/uploads/category/',
                            'table_data_page_url'=>'admin/category/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/category/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/category/form',
                            'addupdate_form'=>'admin_con/category/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'category/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/category/edit',
                            'view_page_url'=>'admin/category/view',
                            /*status*/
                            'status_url'=>'admin/category/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/category/delete_data',
                            'multiple_delete'=>'admin_con/category/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'category',
                            'page_name'=>'category-wise-job',    
