...
class Job_type extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Job Type',
                            'table_name'=>'job_type',
                            'upload_path'=>'media/uploads/job_type/',
                            'table_data_page_url'=>'admin/job_type/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/job_type/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/job_type/form',
                            'addupdate_form'=>'admin_con/job_type/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'job_type/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/job_type/edit',
                            'view_page_url'=>'admin/job_type/view',
                            /*status*/
                            'status_url'=>'admin/job_type/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/job_type/delete_data',
                            'multiple_delete'=>'admin_con/job_type/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'job_type',
                            'page_name'=>'job_type-wise-job',    
