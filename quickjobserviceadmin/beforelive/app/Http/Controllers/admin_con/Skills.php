...
class Skills extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Skills',
                            'table_name'=>'skills',
                            'upload_path'=>'media/uploads/skills/',
                            'table_data_page_url'=>'admin/skills/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/skills/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/skills/form',
                            'addupdate_form'=>'admin_con/skills/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'skills/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/skills/edit',
                            'view_page_url'=>'admin/skills/view',
                            /*status*/
                            'status_url'=>'admin/skills/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/skills/delete_data',
                            'multiple_delete'=>'admin_con/skills/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'skills',
                            'page_name'=>'skills-wise-job',    
