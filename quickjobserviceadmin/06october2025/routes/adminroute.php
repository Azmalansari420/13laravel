...
use App\Http\Controllers\admin_con\Pdf_category;
use App\Http\Controllers\admin_con\Pdfs;
use App\Http\Controllers\admin_con\Pdf_purchase;
use App\Http\Controllers\admin_con\Headline;
...
/*------------------------pdf_purchase----------------------*/
Route::prefix('admin/pdf_purchase')->group(function () {
    Route::get('/', [Pdf_purchase::class, 'listing'])->name('admin/pdf_purchase/list');
    Route::post('/table', [Pdf_purchase::class, 'getTableData'])->name('admin/pdf_purchase/table');
    /*------View------*/
    Route::get('/view/{id}', [Pdf_purchase::class, 'view_page_url'])->name('admin/pdf_purchase/view');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Pdf_purchase::class, 'delete_data'])->name('admin_con/pdf_purchase/delete_data');
    Route::delete('/multiple_delete_data', [Pdf_purchase::class, 'multiple_delete_data'])->name('admin_con/pdf_purchase/multiple_delete_data');
});
...
/*------------------------pdf_category----------------------*/
Route::prefix('admin/pdf_category')->group(function () {
    Route::get('/', [Pdf_category::class, 'listing'])->name('admin/pdf_category/list');
    Route::post('/table', [Pdf_category::class, 'getTableData'])->name('admin/pdf_category/table');
    /*------add------*/
    Route::get('/add', [Pdf_category::class, 'add_page_url'])->name('admin/pdf_category/add');
    /*------upadte------*/
    Route::get('/edit/{id}', [Pdf_category::class, 'edit_page_url'])->name('admin/pdf_category/edit');
    /*----view----*/
    Route::get('/view/{id}', [Pdf_category::class, 'view_page_url'])->name('admin/pdf_category/view');
    /*--single update -delete--*/
    Route::post('/store', [Pdf_category::class, 'storeOrUpdate'])->name('admin_con/pdf_category/storeOrUpdate');
    /*------status------*/
    Route::post('/update_status', [Pdf_category::class, 'updateStatus'])->name('admin/pdf_category/update_status');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Pdf_category::class, 'delete_data'])->name('admin_con/pdf_category/delete_data');
    Route::delete('/multiple_delete_data', [Pdf_category::class, 'multiple_delete_data'])->name('admin_con/pdf_category/multiple_delete_data');
});

/*------------------------pdfs----------------------*/
Route::prefix('admin/pdfs')->group(function () {
    Route::get('/', [Pdfs::class, 'listing'])->name('admin/pdfs/list');
    Route::post('/table', [Pdfs::class, 'getTableData'])->name('admin/pdfs/table');
    /*------add------*/
    Route::get('/add', [Pdfs::class, 'add_page_url'])->name('admin/pdfs/add');
    /*------upadte------*/
    Route::get('/edit/{id}', [Pdfs::class, 'edit_page_url'])->name('admin/pdfs/edit');
    /*----view----*/
    Route::get('/view/{id}', [Pdfs::class, 'view_page_url'])->name('admin/pdfs/view');
    /*--single update -delete--*/
    Route::post('/store', [Pdfs::class, 'storeOrUpdate'])->name('admin_con/pdfs/storeOrUpdate');
    /*------status------*/
    Route::post('/update_status', [Pdfs::class, 'updateStatus'])->name('admin/pdfs/update_status');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Pdfs::class, 'delete_data'])->name('admin_con/pdfs/delete_data');
    Route::delete('/multiple_delete_data', [Pdfs::class, 'multiple_delete_data'])->name('admin_con/pdfs/multiple_delete_data');
});
/*------------------------headline----------------------*/
Route::prefix('admin/headline')->group(function () {
    Route::get('/', [Headline::class, 'listing'])->name('admin/headline/list');
    Route::post('/table', [Headline::class, 'getTableData'])->name('admin/headline/table');
    /*------add------*/
    Route::get('/add', [Headline::class, 'add_page_url'])->name('admin/headline/add');
    /*------upadte------*/
    Route::get('/edit/{id}', [Headline::class, 'edit_page_url'])->name('admin/headline/edit');
    /*----view----*/
    Route::get('/view/{id}', [Headline::class, 'view_page_url'])->name('admin/headline/view');
    /*--single update -delete--*/
    Route::post('/store', [Headline::class, 'storeOrUpdate'])->name('admin_con/headline/storeOrUpdate');
    /*------status------*/
    Route::post('/update_status', [Headline::class, 'updateStatus'])->name('admin/headline/update_status');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Headline::class, 'delete_data'])->name('admin_con/headline/delete_data');
    Route::delete('/multiple_delete_data', [Headline::class, 'multiple_delete_data'])->name('admin_con/headline/multiple_delete_data');
});