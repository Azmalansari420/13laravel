...
class Pdfs extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'PDF',
                            'table_name'=>'pdfs',
                            'upload_path'=>'media/uploads/pdfs/',
                            'table_data_page_url'=>'admin/pdfs/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/pdfs/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/pdfs/form',
                            'addupdate_form'=>'admin_con/pdfs/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'pdfs/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/pdfs/edit',
                            'view_page_url'=>'admin/pdfs/view',
                            /*status*/
                            'status_url'=>'admin/pdfs/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/pdfs/delete_data',
                            'multiple_delete'=>'admin_con/pdfs/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'pdfs',
                            'page_name'=>'pdf-purchase',    
