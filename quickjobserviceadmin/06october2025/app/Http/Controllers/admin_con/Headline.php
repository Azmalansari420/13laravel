...
class headline extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Headline',
                            'table_name'=>'headline',
                            'upload_path'=>'media/uploads/headline/',
                            'table_data_page_url'=>'admin/headline/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/headline/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/headline/form',
                            'addupdate_form'=>'admin_con/headline/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'headline/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/headline/edit',
                            'view_page_url'=>'admin/headline/view',
                            /*status*/
                            'status_url'=>'admin/headline/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/headline/delete_data',
                            'multiple_delete'=>'admin_con/headline/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'headline',
                            'page_name'=>'headline-details',    
