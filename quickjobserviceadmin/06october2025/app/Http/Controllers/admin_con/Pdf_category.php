...
class Pdf_category extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'PDF Category',
                            'table_name'=>'pdf_category',
                            'upload_path'=>'media/uploads/pdf_category/',
                            'table_data_page_url'=>'admin/pdf_category/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/pdf_category/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/pdf_category/form',
                            'addupdate_form'=>'admin_con/pdf_category/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'pdf_category/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/pdf_category/edit',
                            'view_page_url'=>'admin/pdf_category/view',
                            /*status*/
                            'status_url'=>'admin/pdf_category/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/pdf_category/delete_data',
                            'multiple_delete'=>'admin_con/pdf_category/multiple_delete_data',
                            'check_image'=>true,
                            'controller_name'=>'pdf_category',
