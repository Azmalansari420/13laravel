...
class Pdf_purchase extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'PDF Purchase',
                            'table_name'=>'pdf_purchase',
                            'upload_path'=>'media/uploads/pdf_purchase/',
                            'table_data_page_url'=>'admin/pdf_purchase/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/pdf_purchase/list',
                            /*add page*/
                            'view_page_url'=>'admin/pdf_purchase/view',
                            /*delete*/
                            'delete_single_url'=>'admin_con/pdf_purchase/delete_data',
                            'multiple_delete'=>'admin_con/pdf_purchase/multiple_delete_data',
                            'check_image'=>false,  
                           ); 
    ...
    public function getTableData(Request $request)
    {
        ...
        if (!empty($search)) {
            $query->where('pdf_name', 'LIKE', "%{$search}%")
