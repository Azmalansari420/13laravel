          ...
          <div class="nav-outer">
            ...
            <nav class="nav main-menu">
              <ul class="navigation" id="navbar">
                ...
                <li class="{{ $currentUrl == url('about') ? 'current' : '' }}">
                  <a href="{{url('about')}}">About Us</a>
                </li>
                <li class="{{ $currentUrl == url('job') ? 'current' : '' }}">
                  <a href="{{url('job')}}">Find Job</a>
                </li>
                <li class="{{ $currentUrl == url('purchase-notes') ? 'current' : '' }}">
                  <a href="{{url('purchase-notes')}}">Purchase Notes</a>
                </li>

                <li class="{{ $currentUrl == url('blog') ? 'current' : '' }}">
                  <a href="{{url('blog')}}">Blog</a>
                </li>

                
                
                <li class="{{ $currentUrl == url('contact') ? 'current' : '' }}">
