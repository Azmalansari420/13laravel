...
class Partner extends Controller
{
    protected $arr_values = array(
                            ...
                            'table_data_page_url'=>'admin/partner/table',
                            'table_data_pagination_limit'=>10,
                            'load_list_path'=>'admin/partner/list',
                            /*load form path and update url*/
                            'add_form_path'=>'admin/partner/form',
                            'addupdate_form'=>'admin_con/partner/storeOrUpdate',
                            /*add page*/
                            'add_page_link'=>'partner/add',
                            /*edit page*/
                            'edit_page_url'=>'admin/partner/edit',
                            'view_page_url'=>'admin/partner/view',
                            /*status*/
                            'status_url'=>'admin/partner/update_status',
                            /*delete*/
                            'delete_single_url'=>'admin_con/partner/delete_data',
                            'multiple_delete'=>'admin_con/partner/multiple_delete_data',
                            'check_image'=>true,
