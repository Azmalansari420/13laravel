...
use App\Http\Controllers\admin_con\Package_enquiry;
...
Route::prefix('admin/content')->group(function () {
    ...
    /*explore Us*/
    Route::get('/banner/{id}', [Content::class, 'banner_loadForm'])->name('admin/content/banner');
    Route::post('/banner/{id}', [Content::class, 'bannersubmitForm'])->name('admin/content/bannerupdate');
...
/*------------------------package_enquiry----------------------*/
Route::prefix('admin/package_enquiry')->group(function () {
    Route::get('/', [Package_enquiry::class, 'listing'])->name('admin/package_enquiry/list');
    Route::post('/table', [Package_enquiry::class, 'getTableData'])->name('admin/package_enquiry/table');
    /*------View------*/
    Route::get('/view/{id}', [Package_enquiry::class, 'view_page_url'])->name('admin/package_enquiry/view');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Package_enquiry::class, 'delete_data'])->name('admin_con/package_enquiry/delete_data');
    Route::delete('/multiple_delete_data', [Package_enquiry::class, 'multiple_delete_data'])->name('admin_con/package_enquiry/multiple_delete_data');
});
...
Route::prefix('admin/city')->group(function () {
    ...
    Route::delete('/multiple_delete_data', [City::class, 'multiple_delete_data'])->name('admin_con/city/multiple_delete_data');
     ...
     /*addmore single*/
    Route::post('/load_more', [City::class, 'load_more'])->name('admin/city/load_more');
    /*addmore single*/
    Route::post('/load_expierience_more', [City::class, 'load_expierience_more'])->name('admin/city/load_expierience_more');


    Route::post('/load_art_therter_more', [City::class, 'load_art_therter_more'])->name('admin/city/load_art_therter_more');
    Route::post('/load_park_garden_more', [City::class, 'load_park_garden_more'])->name('admin/city/load_park_garden_more');
    Route::post('/load_hotels_more', [City::class, 'load_hotels_more'])->name('admin/city/load_hotels_more');
});
