                ...
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        <div class="tg-location-section-title mb-30">
                            <h5 class="tg-section-su-subtitle mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Top Tour Packages- Your Next Adventure Starts Here</h5>
                            <h2 class="tg-section-su-title text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Explore top travel destinations worldwide with Moxxy DMC</h2>
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-12">
                        <div class="swiper-container tg-location-su-slider">
                            <div class="swiper-wrapper">
                                ...
                                @php
                                $count = DB::table('package')->where('country_id', $data->id)->count();
                                @endphp
                                    ...
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        ...
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                ...
                                                <span class="tg-location-su-duration">{{@$count}} Tours</span>
                                            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-9">
                        <div class="tg-location-section-title mb-40">
                            ...
                            <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Explore top travel cities<br> worldwide with Moxxy DMC</h2>
                        </div>
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tg-listing-section-title text-center mb-35">
                            <h5 class="tg-section-subtitle wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">Top Tour Packages- </h5>
                            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s">Your Next Adventure Starts Here</h2>
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".8s">Craving something different? Travel outside the ordinary with bold new experiences.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
