...
class Package_enquiry extends Controller
{
    protected $arr_values = array(
                            'page_title'=>'Package Enquiry',
                            'table_name'=>'package_enquiry',
                            'upload_path'=>'media/uploads/package_enquiry/',
                            'table_data_page_url'=>'admin/package_enquiry/table',
                            'table_data_pagination_limit'=>15,
                            'load_list_path'=>'admin/package_enquiry/list',
                            /*add page*/
                            'view_page_url'=>'admin/package_enquiry/view',
                            /*delete*/
                            'delete_single_url'=>'admin_con/package_enquiry/delete_data',
                            'multiple_delete'=>'admin_con/package_enquiry/multiple_delete_data',
                            'check_image'=>false,  
                           ); 
