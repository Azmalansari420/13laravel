...
class City extends Controller
{
   ...
   public function getTableData(Request $request)
    ...
    public function load_more(Request $request) 
    {
        ...
        $upload_path = $this->arr_values['upload_path'];
        $page_title = $this->arr_values['page_title'];
        return view("admin/city/add-more", compact('page_title', 'count','upload_path'));
    }
   ...
   public function load_expierience_more(Request $request) 
    {
        ...
        $upload_path = $this->arr_values['upload_path'];
        $page_title = $this->arr_values['page_title'];
        return view("admin/city/expierience-more", compact('page_title', 'count','upload_path'));
    }
   ...
   public function load_art_therter_more(Request $request) 
    {
        ...
        $upload_path = $this->arr_values['upload_path'];
        $page_title = $this->arr_values['page_title'];
        return view("admin/city/art_therter-more", compact('page_title', 'count','upload_path'));
    }
   ...
   public function load_park_garden_more(Request $request) 
    {
        ...
        $upload_path = $this->arr_values['upload_path'];
        $page_title = $this->arr_values['page_title'];
        return view("admin/city/park_garden-more", compact('page_title', 'count','upload_path'));
    }
   ...
   public function load_hotels_more(Request $request) 
    {
        ...
        $upload_path = $this->arr_values['upload_path'];
        $page_title = $this->arr_values['page_title'];
        return view("admin/city/hotels-more", compact('page_title', 'count','upload_path'));
    }
