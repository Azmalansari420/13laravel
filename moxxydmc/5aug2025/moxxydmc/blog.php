                        ...
                        <div class="tg-blog-grid-wrap tg-blog-lg-spacing mr-50">
                            <div class="row">
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">Exploring The Green Spac Realar Residence Area Harmony</a>
                                            </h2>
                                            ...
                                            <p class="mb-20 tg-blog-standard-para">Welcome to Realar Residence, where sustainability meets comfort in every corner. In this blog post, we 
                                                explore the green innovations.</p>
                                            <div class="tg-blog-sidebar-btn">
                                                <a href="blog-details.php" class="tg-btn tg-btn-switch-animation">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid-2.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">An arts and culture guide to Turin, Italy</a>
                                            </h2>
                                            <div class="tg-blog-standard-date mb-10">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid-3.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">Enrich Your Mind Envision Your Future Education for</a>
                                            </h2>
                                            <div class="tg-blog-standard-date mb-10">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid-4.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">Change your place and get the fresh air</a>
                                            </h2>
                                            <div class="tg-blog-standard-date mb-10">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid-5.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">This Spanish city is a feast for the eyes</a>
                                            </h2>
                                            <div class="tg-blog-standard-date mb-10">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-6">
                                    <div class="tg-blog-grid-item mb-30">
                                        <div class="tg-blog-standard-thumb mb-15">
                                            <a href="blog-details.php"><img class="w-100" src="assets/img/blog/grid/grid-6.jpg" alt="blog"></a>
                                        </div>
                                        <div class="tg-blog-standard-content">
                                            <h2 class="tg-blog-standard-title">
                                                <a href="blog-details.php">When you visit the Eternal Rome City</a>
                                            </h2>
                                            <div class="tg-blog-standard-date mb-10">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
