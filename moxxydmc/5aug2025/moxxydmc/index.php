<?php include('header.php'); ?>
    ...
    <main>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://foramworldwide.s3.ap-south-1.amazonaws.com/banner/usatour-19201738672111.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item ">
                        <img src="https://foramworldwide.s3.ap-south-1.amazonaws.com/banner/Iceland-Banner11746189878.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item ">
                        <img src="https://foramworldwide.s3.ap-south-1.amazonaws.com/banner/Spain--Portugal-Banner1744089633.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
        ...
        <div class="tg-chose-area tg-chose-su-2-wrap pt-70 pb-60 p-relative z-index-9 fix">
            <img class="tg-chose-su-2-bg-shape p-absolute" src="assets/img/chose/su/shape.png" alt="">
            <div class="container">
                <div class="row align-items-center">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xxl-8 col-xl-9 col-lg-8 col-md-8">
                                <div class="tg-chose-section-title mb-20">
                                    ...
                                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s" data-wow-duration=".9s">Here is Great opportunity  for adventure & travels</h2>
                                    <p class="tg-section-su-para tg-section-su-para-2 mb-0">Are you tired of the typical tourist destinations and looking 
                            ...
                            <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                                <div class="tg-chose-su-2-thumb mb-25">
                                    <img class="w-100" src="assets/img/chose/su/thumb.jpg" alt="">
                                </div>
                            </div>
                                ...
                                <div class="tg-chose-list-wrap ml-30">
                                    <div class="tg-chose-list d-flex mb-10">
                                        ...
                                        <div class="tg-chose-list-content">
                                            <h4 class="tg-chose-list-title mb-15">Best Travel Agency</h4>
                                            <p>Are you tiredthe typical tourist destina
                                                looking  step outyour comfort.</p>
                                        </div>
                                    </div>
                                    <div class="tg-chose-list d-flex mb-25">
                                        ...
                                        <div class="tg-chose-list-content">
                                            <h4 class="tg-chose-list-title mb-15">Secure Journey With Us</h4>
                                            <p>Are you tiredthe typical tourist destina
                                                looking  step outyour comfort.</p>
                                        </div>
                                    </div>
                                    <div class="tg-chose-list d-flex mb-25">
                                        ...
                                        <div class="tg-chose-list-content">
                                            <h4 class="tg-chose-list-title mb-15">Friendly price</h4>
                                            <p>Are you tiredthe typical tourist destina
                                                looking  step outyour comfort.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-5 col-lg-8">
                        <div class="tg-chose-su-2-main-thumb text-end p-relative wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                            <img class="tg-chose-su-2-main-shape d-none d-sm-block" src="assets/img/chose/su/circle-text.png" alt="">
                            <img class="w-100" src="assets/img/chose/su/thumb-2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tg-location-area p-relative z-index-1 pb-65 pt-70">
            <div class="tg-location-su-bg">
                <img src="assets/img/destination/tu/bg.png" alt="">
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        ...
                        <div class="swiper-container tg-location-su-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" src="assets/img/destination/tu/des-4.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="packages.php">Paris</a></h3>
                                                <span class="tg-location-su-duration">05 Tours</span>
                                            </div>
                                            <a class="icons" href="packages.php">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" src="assets/img/destination/tu/des-2.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="packages.php">Australia</a></h3>
                                                <span class="tg-location-su-duration">05 Tours</span>
                                            </div>
                                            <a class="icons" href="packages.php">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" src="assets/img/destination/tu/des-3.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="packages.php">New York City</a></h3>
                                                <span class="tg-location-su-duration">05 Tours</span>
                                            </div>
                                            <a class="icons" href="packages.php">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" src="assets/img/destination/tu/des-1.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="packages.php">Spain City</a></h3>
        ...
        <div class="tg-location-area pt-70 pb-70 tg-grey-bg p-relative z-index-1">
            <img class="tg-location-shape d-none d-xl-block" src="assets/img/location/shape-2.png" alt="">
            <div class="container">
                                        ...
                                        <div class="bt_bb_grid_item bt_bb_tile_format11">
                                            <div class="bt_bb_grid_item_inner" data-hw="1">
                                                <div class="bt_bb_grid_item_post_thumbnail">
                                                    <a href="tour-packages.php" title="Moscow">
                                                        <img class="bt_bb_grid_item_inner_image" src="assets/moscow.jpg">
                                                    </a>
                                                </div>
                                                <div class="bt_bb_grid_item_inner_content"><h5 class="bt_bb_grid_item_post_title">Moscow</h5><div class="bt_bb_grid_item_post_excerpt">Moscow, Russian Moskva, city, capital of Russia, located in the far western part of the country. Since it was first mentioned in the chronicles of 1147.</div></div><div class="bt_bb_grid_item_post_title_init"><h5>Moscow</h5></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="gallery_item-wrap Russia">
                                        <div class="bt_bb_grid_item bt_bb_tile_format11">
                                            <div class="bt_bb_grid_item_inner" data-hw="1">
                                                <div class="bt_bb_grid_item_post_thumbnail">
                                                    <a href="tour-packages.php" title="&gt;Saint Petersburg">
                                                        <img class="bt_bb_grid_item_inner_image" src="assets/SaintPetersburg.jpg">
                                                    </a>
                                                </div>
                                                <div class="bt_bb_grid_item_inner_content"><h5 class="bt_bb_grid_item_post_title">Saint Petersburg</h5><div class="bt_bb_grid_item_post_excerpt">A major historical and cultural centre and an important port, St. Petersburg lies about 400 miles (640 km) northwest of Moscow and only about 7° south of the Arctic Circle.</div></div><div class="bt_bb_grid_item_post_title_init"><h5>Saint Petersburg</h5></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="gallery_item-wrap Russia">
                                        <div class="bt_bb_grid_item bt_bb_tile_format11">
                                            <div class="bt_bb_grid_item_inner" data-hw="1">
                                                <div class="bt_bb_grid_item_post_thumbnail">
                                                    <a href="tour-packages.php" title="Sochi">
                                                        <img class="bt_bb_grid_item_inner_image" src="assets/sochi.jpg">
                                                    </a>
                                                </div>
                                                <div class="bt_bb_grid_item_inner_content"><h5 class="bt_bb_grid_item_post_title">Sochi</h5><div class="bt_bb_grid_item_post_excerpt">Sochi is often called the unofficial 'Summer Capital' of Russia, or the Black Sea Pearl. This is the country's biggest and busiest summer sea resort, attracting more than four million visitors.</div></div><div class="bt_bb_grid_item_post_title_init"><h5>Sochi</h5></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="gallery_item-wrap Russia">
                                        <div class="bt_bb_grid_item bt_bb_tile_format11">
                                            <div class="bt_bb_grid_item_inner" data-hw="1">
                                                <div class="bt_bb_grid_item_post_thumbnail">
                                                    <a href="tour-packages.php" title="Kaliningrad">
                                                        <img class="bt_bb_grid_item_inner_image" src="assets/Kaliningrad.jpg">
                                                    </a>
                                                </div>
                                                <div class="bt_bb_grid_item_inner_content"><h5 class="bt_bb_grid_item_post_title">Kaliningrad</h5><div class="bt_bb_grid_item_post_excerpt">The world’s biggest country has a geopolitical oddity: the region of Kaliningrad. This enclave is a fragment of Russian territory the size of Yorkshire, squeezed between Poland and Lithuania. </div></div><div class="bt_bb_grid_item_post_title_init"><h5>Kaliningrad</h5></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                            ...
                            <div class="tg-listing-card-content p-relative">
                                ...
                                <div class="d-flex justify-content-between mt-2 align-items-center">
                                    <a href="package-details.php" class="blue-color">Details</a>
                                    <a href="package-details.php" class="red-color">Book Online</a>
                                    <a href="javascript:void(0)" class="blue-color" onclick="open_model('Azmal')">Enquiry</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".6s">
                        <div class="tg-listing-2-btn text-center pt-25">
                            <a href="" class="tg-btn tg-btn-switch-animation">
        ...
        <div class="tg-banner-area tg-banner-4-spacing" data-background="assets/img/banner/banner-4/banner-4.png">
            <div class="container">
                <div class="col-lg-12">
                    <div class="tg-banner-2-content tg-banner-4-content text-center">
                        <div class="tg-about-section-title mb-25">
                            <h5 class="tg-section-subtitle mb-20 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Next Adventure Destination</h5>
                            <h2 class="tg-section-title-white mb-30 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Popular Travel Destinations <br>Available Worldwide</h2>
                        </div>
                        <div class="tp-banner-btn-wrap wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                            <a href="" class="tg-btn tg-btn-transparent tg-btn-switch-animation">
                                <span class="d-flex align-items-center justify-content-center">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="tg-cta-4-spacing tg-primary-bg p-relative z-index-1">
                            <img class="tg-cta-3-shape-2 d-none d-md-block" src="assets/img/cta/cta-3/shape-2.png" alt="">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="tg-cta-4-thumb mr-25 p-relative z-index-1  pt-85 ">
                                        <img class="w-100" src="assets/img/cta/cta-4/thumb.png" alt="">
                                        <img class="tg-cta-3-shape rotate-infinite" src="assets/img/cta/cta-3/shape.png" alt="shape">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="tg-cta-4-content mb-20 pt-15">
                                        ...
                                        <div class="tg-cta-3-apps pt-15 d-flex align-items-center">
                                            <a class="mb-10 d-inline-block mr-10" href="#"><img src="assets/img/cta/google.png" alt=""></a>
                                            <a class="mb-10 d-inline-block" href="#"><img src="assets/img/cta/app.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="tg-testimonial-area tg-testimonial-su-2 pt-100 pb-100">
            <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    <div class="tg-testimonial-avatar-top d-flex align-items-start justify-content-between">
                                        <div class="tg-testimonial-avatar-inner d-flex align-items-center mr-20 mb-20">
                                            <div class="tg-testimonial-avatar-thumb mr-15">
                                                <img class="rounded-circale" src="assets/img/testimonial/avatar.png" alt="avatar">
                                            </div>
                                            <div class="tg-testimonial-avatar-content">
                                                <h5>Esther Howard</h5>
                                                <span>CEO, Traveller</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="tg-testimonial-avatar-para mb-10">“ Morem ipsum dolor siterey amet mean earty areaeey consec taetur adipisrvice ollwing 
                                        ipsum dolor consectetur.”</p>
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    <div class="tg-testimonial-avatar-top d-flex align-items-start justify-content-between">
                                        <div class="tg-testimonial-avatar-inner d-flex align-items-center mr-20 mb-20">
                                            <div class="tg-testimonial-avatar-thumb mr-15">
                                                <img class="rounded-circale" src="assets/img/testimonial/avatar-2.png" alt="avatar">
                                            </div>
                                            <div class="tg-testimonial-avatar-content">
                                                <h5>Floyd Miles</h5>
                                                <span>CEO, Traveller</span>
                            ...
                            <div class="swiper-slide">
                                <div class="tg-testimonial-item mb-30">
                                    <div class="tg-testimonial-avatar-top d-flex align-items-start justify-content-between">
                                        <div class="tg-testimonial-avatar-inner d-flex align-items-center mr-20 mb-20">
                                            <div class="tg-testimonial-avatar-thumb mr-15">
                                                <img class="rounded-circale" src="assets/img/testimonial/avatar-3.png" alt="avatar">
                                            </div>
                                            <div class="tg-testimonial-avatar-content">
                                                <h5>Jacob Jones</h5>
                                                <span>CEO, Traveller</span>
                            ...
                            <div class="swiper-wrapper slide-transtion">
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
                                        <a href="#"><img src="assets/img/brand/logo-1.png" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
                                        <a href="#"><img src="assets/img/brand/logo-2.png" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
                                        <a href="#"><img src="assets/img/brand/logo-3.png" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
                                        <a href="#"><img src="assets/img/brand/logo-4.png" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
                                        <a href="#"><img src="assets/img/brand/logo-5.png" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="tg-brand-items">
        ...
        <!-- blog-area-start -->
        <div class="tg-blog-area pt-70 pb-70 include-bg p-relative z-index-1" data-background="assets/img/blog/blog-4/blog.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".4s" data-wow-duration=".9s">
                        <div class="tg-blog-item tg-blog-2-item mb-25">
                            <div class="tg-blog-thumb p-relative fix mb-20">
                                <a href=""><img class="w-100" src="assets/img/blog/blog-2/blog-1.jpg" alt="blog"></a>
                                <span class="tg-blog-tag p-absolute">Travel River</span>
                            </div>
                            <div class="tg-blog-content  p-relative">
                                <h3 class="tg-blog-title"><a href="">Spiritual Sojourn mageey 
                                    for Soul Seekers</a></h3>
                                <div class="tg-blog-date mb-10">
                                    <span class="mr-20"><i class="fa-light fa-calendar"></i> 26th Sep, 2024</span>
                                    <span><i class="fa-regular fa-clock"></i> 5 mins Read</span>
                                </div>
                                <p class="tg-blog-text mb-0">Are you tired the typical tourist destinat
                                    ons and looking step out of your comf
                                    ort zone travel.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                        <div class="tg-blog-item tg-blog-2-item mb-25">
                            <div class="tg-blog-thumb p-relative fix mb-20">
                                <a href=""><img class="w-100" src="assets/img/blog/blog-2/blog-2.jpg" alt="blog"></a>
                                <span class="tg-blog-tag p-absolute">Travel River</span>
                            </div>
                            <div class="tg-blog-content  p-relative">
                                <h3 class="tg-blog-title"><a href="">Wine Country Escapeeyard 
                                    Tours for Connoisseurs</a></h3>
                                <div class="tg-blog-date mb-10">
                                    <span class="mr-20"><i class="fa-light fa-calendar"></i> 26th Sep, 2024</span>
                                    <span><i class="fa-regular fa-clock"></i> 5 mins Read</span>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".9s">
                        <div class="tg-blog-item tg-blog-2-item mb-25">
                            <div class="tg-blog-thumb p-relative fix mb-20">
                                <a href=""><img class="w-100" src="assets/img/blog/blog-2/blog-3.jpg" alt="blog"></a>
                                <span class="tg-blog-tag p-absolute">Travel River</span>
                            </div>
                            <div class="tg-blog-content  p-relative">
                                <h3 class="tg-blog-title"><a href="">Thrills & Chills treme Sports 
                                    Tours for Adrenaline</a></h3>
                                <div class="tg-blog-date mb-10">
                                    <span class="mr-20"><i class="fa-light fa-calendar"></i> 26th Sep, 2024</span>
                                    <span><i class="fa-regular fa-clock"></i> 5 mins Read</span>
                                </div>
