                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="tg-header-top-info d-flex align-items-center">
                                <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z"><i class="mr-5 fa-regular fa-location-dot"></i> 178 makr street, 8007 Australia</a>
                                <span class="tg-header-dvdr mr-10 ml-10"></span>
                                <a href="mailto:info@moxxydmc"><i class="mr-5 fa-regular fa-envelope"></i> info@moxxydmc</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-11 col-7">
                            <div class="tgmenu__wrap d-flex align-items-center">
                                <div class="logo flex-auto">
                                    <a href="index.php"><img src="assets/logo.png" alt="Logo" style="width: 213px;"></a>
                                </div>
                                <nav class="tgmenu__nav  header-margin d-none d-xl-block">
                                    <div class="tgmenu__navbar-wrap tgmenu__main-menu tgmenu__navbar-wrap-4 d-none d-xl-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="about.php"><a href="about.php">ABOUT US</a></li>

                                            <li class="menu-item-has-children"><a href="tours.php">DESTINATION</a>
                                                <ul class="sub-menu">
                                                    <li><a href="tour-packages.php">Russia</a></li>
                                                    <li><a href="tour-packages.php">Azerbaijan</a></li>
                                                    <li><a href="tour-packages.php">Kazakhstan</a></li>
                                                    <li><a href="tour-packages.php">Georgia</a></li>
                                                </ul>
                                            </li>
