<style>
    ...
    <footer>
        <div class="tg-footer-area pt-130 include-bg" data-background="https://static.toiimg.com/photo/msid-83890076,width-96,height-65.cms">
           <div class="container">
                <div class="tg-footer-top pb-40">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="tg-footer-widget mb-40">
                                <div class="tg-footer-logo mb-20">
                                    <a href=""><img src="assets/logo.png" alt="" style="background: white;padding: 8px;border-radius: 6px;"></a>
                                </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                            <div class="tg-footer-widget tg-footer-link mb-40">
                                <h3 class="tg-footer-widget-title mb-25">International Tour</h3>
                                <ul>
            ...
            <div class="tg-footer-copyright text-center">
                <span>
                    Copyright <a href="#">© MOXXY DMC</a> |  All Right Reserved
                </span>
            </div>
        </div>
    </footer>
